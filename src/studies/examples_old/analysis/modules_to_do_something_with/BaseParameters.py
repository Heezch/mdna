...
class ReferenceBase:
    ...
    def calculate_base_frame(self):
        ...
        R_b_R = Geometry.get_rotation_matrix(self.tau_1 * b_N)
        ...
        R_b_L = Geometry.get_rotation_matrix(self.tau_2 * b_N)
...
class Frames:
    ...
    def get_rotation_angles(self,rotation_matrix_AB, rotation_matrix_BA):
        ...
        return Geometry.extract_omega_values(rotation_matrix_AB), Geometry.extract_omega_values(rotation_matrix_BA)

    def get_mid_frame(self,rotation_angle_BA, rotation_A, origin_A, origin_B):
        # Compute halfway rotation matrix and triad (mid frame)
        halfway_rotation_matrix = Geometry.get_rotation_matrix(rotation_angle_BA * 0.5)
